...
### את לוגיקת המשחק ואת לולאת המשחק ניתן להציג גם בצורה גרפית כתרשים זרימה. לפניכם תרשים זרימה של משחק פשוט. שימו לב למקרא- הוא יעזור לכם להבין את התרשים.
...
![Flowchart of game logic](/assets/lesson_7/Game_Logic_Flowchart.png "Game Logic Flowchart")
...
![ERROR Couldn't load image](/assets/lesson_7/slide1.png "Game Logic Flowchart")
...
### ✓9. לולאת המשחק:
עכשיו כשיש בידכם את כל הפעולות הדרושות בשביל לבצע את המשחק ואת תרשים השרימה של המשחק, נסו לכתוב את הפעולה הראשית אשר תכין את כל הפעולותשל הלוגיקה ואת לולאת המשחק.
